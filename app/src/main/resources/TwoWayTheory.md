...
3) In opposition to 2), one party MUST act as a server, and the other MUST act as a swiss. The alternative is full of bugs and issues.
...
This new model allows either end of communication to initially act as though it is the swiss in the swiss-server relationship, attempting to connect its own Socket to the other's ServerSocket.
