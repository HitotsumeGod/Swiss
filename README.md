...
*Swiss* is the premier peer-to-peer messaging application for absolutely isolated private conversations. Ditching the swiss-server-swiss model allows *Swiss* to offer an objective guarantee
